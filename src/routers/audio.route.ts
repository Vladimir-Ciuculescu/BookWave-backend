...
import { audioSchema } from "../yup-schemas/audio.schemas";
import { isVerifiedMiddleware } from "../middlewares/is-verified.middleware";

const router: any = Router();

router.post("/add", isAuthenticatedMiddleware, isVerifiedMiddleware, fileParserMiddleware, validateMiddleware(audioSchema), AudioController.addAudioFile);
